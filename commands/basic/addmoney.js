...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        if (!target) return message.reply('Mencione o usuário. Ex: `!addmoney @user 100`');
        ...
        return message.reply(`✅ Adicionado 💰 **${amount.toLocaleString('pt-BR')}** para **${target.user.tag}**. Novo saldo: **${data[target.id].toLocaleString('pt-BR')}**.`);
    },
};
